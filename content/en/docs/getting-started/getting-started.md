...
> **Note**: Please read the [Important Information](/docs/getting-started/important/) page first if you haven't already.
...
{{< figure src="/images/photoculling/start.png" alt="PhotoCulling startup screen" position="center" style="border-radius: 8px;" >}}
...
Continue to the [Culling Photos](/docs/getting-started/culling/) guide to learn how to mark, review, and finalize your culled collection.
